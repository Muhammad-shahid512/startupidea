                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <input class="form-control" id="search" required placeholder="Search data........" name="search" value={{request("search")}}>
...
<a href="{{ route('category.delete', $value->id) }}" style="text-decoration: none;">
