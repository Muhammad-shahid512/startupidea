                ...
                <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action={{route("blog.updatepostblog",$data->id)}} method="post">
                                    @csrf
                                    <lable>Blog Title</lable>
                                        <div class="form-group mt-2">
                                            <input class="form-control form-control-lg @error('title') is-invalid @enderror"name="title" type="text" placeholder="" value="{{$data->title}}">
                                      @error('title')
