                    ...
                    <div class="card border-0 shadow mb-4">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="p-3 border rounded mt-0 mb-3">
                                    ...
                                    <div class="title_content" style="width: 100%; display: flex; align-items: center;">
                                        ...
                                        <div class="ms-auto">
                                            <small class="btn btn-secondary btn-sm"
                                                style="">{{ $idea->ideacate->name }}</small>
                                ...
                                <hr>
                                <a href="{{ route('viewfeedback', $idea->slug) }}" class="btn btn-sm btn-info"
                                    id="viewfeedback" onclick="view()">View
                                    Feedback</a>
                                <div class="comments d-block" id="xxl">
                                    <section class="mt-2">
                                        ...
                                        <div class="user_comments">
                                            ...
                                            @foreach ($idea->getfeedback as $value)
                                                <div
                                                    class="profile_header d-flex justify-content-between align-items-center ">
                                                    <div class="d-flex align-items-center mt-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="mb-0  text-muted"
                                                                style="font-size: 14px;800;margin-left:15px;">
                                                                {{ $value->getuser->working }}</p>
                                                        </div>
                                                    </div>
