                ...
                <div class="col-lg-9">
                    ...
                    <div class="card border-0 shadow mb-4">
                        <div class="card-body  p-4">
                            ...
                            @forelse ($idea as $value)
                                <div class="p-3 border rounded mt-3">
                                    <div class="profile_header d-flex justify-content-between align-items-center ">
                                        <div class="d-flex align-items-center">
                                            ...
                                            @else
                                                <div class="rounded-circle bg-secondary text-white d-flex align-items-center justify-content-center mr-3"
                                                    style="width: 75px; height: 80px; font-size: 16px; border: 1px solid #ccc;">
                                        ...
                                        <div>
                                            <div class="ms-auto">
                                                <a href="{{ route('user.updateidea', $value->id) }}">
                                                    <i class="bi bi-pencil btn btn-sm btn-info"></i>
                                                </a>
                                                <a href="{{ route('user.deleteidea', $value->id) }}"> <i
                            ...
                            @else
                                <a href="{{ route('user.getidea', ['show' => 'all']) }}" class="btn btn-primary">Show
                                    All</a>
                            @endif
