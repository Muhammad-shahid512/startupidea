                ...
                <div class="card shadow border-0 p-5">
                    ...
                    @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Email">
                       @error('name')
...
@enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="last_name" id="name" class="form-control @error('last_name') is-invalid @enderror" placeholder="Enter Password">
                       @error('last_name')
    <div class="text-danger">{{ $message }}</div>
@enderror
                        </div> 
